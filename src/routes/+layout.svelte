...
<Footer >
  <FooterCopyright by="W4RD28" year={2023} />
  <div class="py-6 px-4 md:flex md:items-center md:justify-between">
    <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0">
      <FooterIcon href="https://www.instagram.com/windunursetyadi/" class="text-gray-600">
      ...
      <FooterIcon href="https://github.com/W4RD28" class="text-gray-600">
